...
class Pegawai extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_user, id_jabatan, id_agama, id_unit, id_kota_lahir', 'numerical', 'integerOnly'=>true),
			array('nip, hp', 'length', 'max'=>30),
			array('nama_pegawai', 'length', 'max'=>250),
			...
			array('id_pegawai, id_user, id_jabatan, id_agama, id_unit, nip, nama_pegawai, gelar_depan, gelar_belakang, tgl_lahir, id_kota_lahir, alamat, telephone, hp', 'safe', 'on'=>'search'),
		);
	}
