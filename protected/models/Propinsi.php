...
class Propinsi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_negara', 'numerical', 'integerOnly'=>true),
			array('nama_propinsi', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_propinsi, id_negara, nama_propinsi', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nama_propinsi',$this->nama_propinsi,true);
