...
header("Content-disposition: attachment; filename=lap-PFL-registrasi-" . $pil_bulan . ".xls");

function biayaPendaftaran($noreg, $jenis, $tgl) {
...
function getData($tgl) {
    $query = "SELECT b.waktu_pembayaran, a.nama_penanggung_jawab, a.instansi_asal as nama_instansi,
                ...
                LEFT JOIN pembayaran_penyewaan b ON a.no_registrasi_penyewaan = b.no_registrasi_penyewaan and b.status_pembayaran='1'
...
<table width="100%" border="1" rules="all">
    ...
    <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right"><b><?php
                        if ($d['status_perpanjangan'] == '2') {
                            ...
                            $pendaftaran1 = biayaPendaftaran($d['id_registrasi_penyewaan'], 'Bench Fee',$pil_bulan);
                ...
                <td style="text-align: right"><b><?php
                        if ($d['status_perpanjangan'] == '2') {
                            ...
                            $pendaftaran2 =biayaPendaftaran($d['id_registrasi_penyewaan'], 'Deposit',$pil_bulan);
                        }
                ...
                <td style="text-align: right"><b><?php
                        if ($d['status_perpanjangan'] == '2') {
                            ...
                            $pendaftaran3 = biayaPendaftaran($d['id_registrasi_penyewaan'], 'Administrasi',$pil_bulan);
                ...
                <td style="text-align: right"><b><?php
                        $pelunasanTotal = $pendaftaran1 + $pendaftaran3 - $pendaftaran2;
        ...
        <tr>
            ...
            <td style="text-align: right"><b><?php echo $this->idr($Jpendaftaran1); ?></b></td>
            <td style="text-align: right"><b><?php echo $this->idr($Jpendaftaran2); ?></b></td>
            <td style="text-align: right"><b><?php echo $this->idr($Jpendaftaran3); ?></b></td>
