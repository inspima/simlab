                    ...
                    <fieldset>
                       ...
                       <div class="control-group">											
                            ...
                            <div class="controls">
                                ...
                                <?php if($pil_tahun != '') {echo '<a class="btn btn-info" href="'.Yii::app()->createUrl("laporan/pemeriksaan/excelLks?id=$pil_tahun").'"><i class="icon-arrow-down"></i>&nbsp;&nbsp;Download Excel</a>';} ?> 
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        
                            <table style="margin :1px 1px" id="dokter-datatable" class="table table-bordered" cellspacing="0" width="120%">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <?php 
                                    ...
                                    foreach($pasien_riset as $d ):
                                      ...
                                      <td>'; $total = $jan + $feb + $mar + $apr + $mei + $jun + $jul + $agu + $sep + $okt + $nov + $des; echo $total.'</td>
                                      </tr>';  
                                ...
                                ?>
                                <tr>
                                    <td><b><?php echo $PFL_instansi = 2; ?></b></td>
                                    <td><b><?php echo 'PFL dari Instansi / Lab. Klinik' ?></b></td>
                                    <td><?php $jan = getjml2($PFL_instansi, $pil_tahun.'-01'); echo $jan; ?></td>
                                    <td><?php $feb = getjml2($PFL_instansi, $pil_tahun.'-02'); echo $feb;  ?></td>
                                    <td><?php $mar = getjml2($PFL_instansi, $pil_tahun.'-03'); echo $mar; ?></td>
                                    <td><?php $apr = getjml2($PFL_instansi, $pil_tahun.'-04'); echo $apr; ?></td>
                                    <td><?php $mei = getjml2($PFL_instansi, $pil_tahun.'-05'); echo $mei; ?></td>
                                    <td><?php $jun = getjml2($PFL_instansi, $pil_tahun.'-06'); echo $jun; ?></td>
                                    <td><?php $jul = getjml2($PFL_instansi, $pil_tahun.'-07'); echo $jul; ?></td>
                                    <td><?php $agu = getjml2($PFL_instansi, $pil_tahun.'-08'); echo $agu; ?></td>
                                    <td><?php $sep = getjml2($PFL_instansi, $pil_tahun.'-09'); echo $sep; ?></td>
                                    <td><?php $okt = getjml2($PFL_instansi, $pil_tahun.'-10'); echo $okt; ?></td>
                                    <td><?php $nov = getjml2($PFL_instansi, $pil_tahun.'-11'); echo $nov; ?></td>
                                    <td><?php $des = getjml2($PFL_instansi, $pil_tahun.'-12'); echo $des; ?></td>
                                    <td><?php $total = $jan + $feb + $mar + $apr + $mei + $jun + $jul + $agu + $sep + $okt + $nov + $des; echo $total; ?></td>
                                </tr>
                                <?php
                                        $j_jan = $j_jan + $jan;     $j_jun = $j_jun + $jun;  $j_nov = $j_nov + $nov; 
                                        $j_feb = $j_feb + $feb;     $j_jul = $j_jul + $jul;  $j_des = $j_des + $des;
                                ...
                                <?php 
                                $total_pendapatan = 0;      $P_apr = 0;      $P_agu = 0;      $P_des = 0;  
                                $P_jan = 0;                 $P_mei = 0;      $P_sep = 0;        
                                $P_feb = 0;                 $P_jun = 0;      $P_okt = 0;        
                                $P_mar = 0;                 $P_jul = 0;      $P_nov = 0;
                                
                                ?>
                                 <tr>
                                    <td><b><?php echo '3' ?></b></td>
                                    <td><b><?php echo 'Pendapatan Bulanan (dalam ribuan Rp)'; ?></b></td>
                                    <td><?php $P_jan = getPendapatan($pil_tahun.'-01'); echo $this->idr($P_jan); ?></td>
                                    <td><?php $P_feb = getPendapatan($pil_tahun.'-02'); echo $this->idr($P_feb);  ?></td>
                                    <td><?php $P_mar = getPendapatan($pil_tahun.'-03'); echo $this->idr($P_mar); ?></td>
                                    <td><?php $P_apr = getPendapatan($pil_tahun.'-04'); echo $this->idr($P_apr); ?></td>
                                    <td><?php $P_mei = getPendapatan($pil_tahun.'-05'); echo $this->idr($P_mei); ?></td>
                                    <td><?php $P_jun = getPendapatan($pil_tahun.'-06'); echo $this->idr($P_jun); ?></td>
                                    <td><?php $P_jul = getPendapatan($pil_tahun.'-07'); echo $this->idr($P_jul); ?></td>
                                    <td><?php $P_agu = getPendapatan($pil_tahun.'-08'); echo $this->idr($P_agu); ?></td>
                                    <td><?php $P_sep = getPendapatan($pil_tahun.'-09'); echo $this->idr($P_sep); ?></td>
                                    <td><?php $P_okt = getPendapatan($pil_tahun.'-10'); echo $this->idr($P_okt); ?></td>
                                    <td><?php $P_nov = getPendapatan($pil_tahun.'-11'); echo $this->idr($P_nov); ?></td>
                                    <td><?php $P_des = getPendapatan($pil_tahun.'-12'); echo $this->idr($P_des); ?></td>
                                    <td><?php $total_pendapatan = $P_jan + $P_feb + $P_mar + $P_apr + $P_mei + $P_jun + $P_jul + $P_agu + $P_sep + $P_okt + $P_nov +  $P_des;  echo $this->idr($total_pendapatan);  ?></td>
                                </tr>  
                            </tbody>
                            </table>
                        <br />
