                ...
                <form class="form-horizontal form-validation"  method="post" style="width: 90%">
                    <fieldset>
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span5 validate[required]" name="username" value="<?php echo $personil['username'] ?>" />
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8 validate[required]" name="password" value="">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
