                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                                ...
                                <fieldset>
                                    ...
                                    if (!empty($data_pasien)) {
                                        ...
                                        <div class="control-group">											
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span8 validate[required]" name="telepon" value="<?php echo $data_pasien['telephone'] ?>">
                                            </div> <!-- /controls -->				
                                        </div> <!-- /control-group -->
                                        ...
                                        <div class="control-group">											
                                            <label class="control-label" for="telepon">Telepon</label>
                                            <div class="controls">
                                                <input type="text" class="span8 validate[required]" name="telepon" value="">
                                            </div> <!-- /controls -->				
                                        </div> <!-- /control-group -->
                                ...
                                <fieldset>
                                    ...
                                    if (!empty($data_registrasi)) {
                                        ...
                                        <div class="control-group">											
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span4 validate[required]" id="no_registrasi" name="no_registrasi" readonly="" value="<?php echo $data_registrasi['no_registrasi'] ?>">
                                            </div> <!-- /controls -->				
                                        </div> <!-- /control-group -->
                                        ...
                                        <div class="control-group">											
                                            <label class="control-label" for="no_registrasi">No.Registrasi</label>
                                            <div class="controls">
                                                <input type="text" class="span5 validate[required]" readonly="" id="no_registrasi" name="no_registrasi" value="">
                                            </div> <!-- /controls -->				
                                        </div> <!-- /control-group -->
                        ...
                        <div class="tab-pane <?php if ($step == 4) echo 'active'; ?>" id="sample">
                            ...
                            <p style="margin: 20px 0px"><a class="btn btn" href="<?php echo Yii::app()->createUrl('registrasi/sample_pasien/read'); ?>"><i class="icon-chevron-left"></i>&nbsp;&nbsp;Back</a></p>
                            ...
                            <form class="form-horizontal form-validation" method="post" style="width: 98%;margin: 10px 10px 10px 10px">
                                <fieldset>
                                    ...
                                    <div class="control-group">											
                                        ...
                                        <div class="controls">
                                            <input type="text" id="total_biaya" class="span4 " name="kode" value="">
                                        </div> <!-- /controls -->				
                                    </div> <!-- /control-group -->
                                            ...
                                            foreach ($data_pasien_pemeriksaan as $dpp) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 200px">
                                                        <div>
                                                            <select name="sample<?php echo $no ?>[]" class="chosen" multiple="" data-placeholder="Pilih Sample Pasien" tabindex="2">
                                                                <?php
                                                                $jumlah_pemeriksaan_sample = 0;
                                                                foreach ($dpp['data_sample'] as $d):
                                                                    if ($d['id_pemeriksaan_sample'] != '') {
                                                                        $jumlah_pemeriksaan_sample++;
                                                                    }
                                                                    ?>
                                                                    <option value="<?php echo $d['id_registrasi_pasien_sample'] ?>" <?php if ($d['id_pemeriksaan_sample'] != '') echo "selected"; ?>><?php echo $d['nama_sample'] . ($d['keterangan_sample'] != '' ? ' [' . $d['keterangan_sample'] . ']' : '') ?></option>
                                                                    <?php
                                                                endforeach;
                                                ...
                                                <?php
                                                $no++;
                                                $total_pasien_pemeriksaan += $dpp['besar_tarif'] * $jumlah_pemeriksaan_sample;
                                            }
                                            ?>
                                            <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                ...
                                                if (in_array($pem['status_pembayaran'], array(1))) {
                                                    ?>
                                                    <a class="btn" href="<?php echo Yii::app()->createUrl('registrasi/cetak/bayar_pemeriksaan?reg=' . $id_registrasi); ?>" target="_blank" title="Cetak Bukti Bayar" ><i class="icon-print"></i></a>
                                                    <?php
                                                }
                                                ?>
                                            </td>
