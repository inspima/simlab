                                    ...
                                    <div class="accordion-inner">
                                        ...
                                        foreach($data_pasien_pemeriksaan as $dpp){
                                            if($dpp['file_lampiran']!=''){
                                                ?>
                                                <a class="btn btn-info" href="<?php echo Yii::app()->createUrl('files/hasil_pemeriksaan/' . $dpp['file_lampiran']); ?>" target="_blank" title="Cetak Lampiran" id="" ><i class="icon-print"></i> Lampiran : <?php echo $dpp['nama_pengujian'] ?></a>
                                                <?php
                                            }else{
                                                ?>
