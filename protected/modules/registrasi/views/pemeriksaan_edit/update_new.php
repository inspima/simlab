    ...
    <div class="span12">
        <div class="widget">
            <div class="widget-header">
                ...
                <h3>Registrasi Pemeriksaan Edit</h3>
            </div> <!-- /widget-header -->
            <div class="widget-content">
                <p style="margin: 20px 0px">
                    <a class="btn btn" href="<?php echo Yii::app()->createUrl('registrasi/pemeriksaan_edit/read'); ?>"><i class="icon-chevron-left"></i>&nbsp;&nbsp;Back</a>
                </p>
                    ...
                    <div class="controls">
                        ...
                        <div class="accordion" id="accordion-pemeriksaan">
                            <div class="accordion-group">
                                ...
                                <div id="collapse-satu" class="accordion-body collapse <?php if ($step == 1) {
                                    echo 'in';
                                } ?>">
                                            ...
                                            <fieldset>
                                                <?php
                                                    if (!empty($data_registrasi)) {
                                                        ?>
                                                        <input type="hidden" id="id_pasien_hidden" value="<?= $data_registrasi['id_pasien'] ?>"/>
                                                        <div class="control-group">
                                                                    ...
                                                                    <select name="instansi" class="chosen" id="instansi" data-placeholder="Pilih Instansi..." tabindex="2">
                                                                        <?php
                                                                            foreach ($data_instansi as $d):
                                                                                ?>
                                                                                <option value="<?php echo $d['id_instansi'] ?>" <?php if ($data_registrasi['id_instansi'] == $d['id_instansi']) {
                                                                                    echo "selected='true'";
                                                                        ...
                                                                        <?php
                                                                            foreach ($data_pasien_tipe as $d):
                                                                                if ($d['jenis_pasien_tipe'] == 2) {
                                                                                    ?>
                                                                                    <option value="<?php echo $d['id_pasien_tipe'] ?>" <?php if ($data_registrasi['id_pasien_tipe'] == $d['id_pasien_tipe']) {
                                                                                        echo "selected='true'";
                                                                                    } ?>><?php echo $d['nama_pasien_tipe'] ?></option>
                                                                                    <?php
                                                                                }
                                                                            endforeach;
                                                                        ?>
                                                                    ...
                                                                    <select name="dokter_pengirim" class="chosen span5" data-placeholder="Pilih Dokter..." tabindex="2">
                                                                        ...
                                                                        <?php
                                                                            foreach ($data_dokter as $d):
                                                                                ?>
                                                                                <option value="<?php echo $d['id_dokter'] ?>" <?php if ($data_registrasi['id_dokter_pengirim'] == $d['id_dokter']) {
                                                                                    echo "selected='true'";
                                                                                } ?>><?php echo $d['gelar_depan'] . ' ' . $d['nama_dokter'] . ' ' . $d['gelar_belakang'] ?></option>
                                                                            <?php
                                                                            endforeach;
                                                                        ?>
                                                                    </select>
                            ...
                            <div class="accordion-group">
                                ...
                                <div id="collapse-dua" class="accordion-body collapse <?php if ($step == 2) {
                                    echo 'in';
                                } ?>">
                                    <div class="accordion-inner">
                            ...
                            <div class="accordion-group">
                                ...
                                <div id="collapse-tiga" class="accordion-body collapse <?php if ($step == 3) {
                                    echo 'in';
                                } ?>">
                                    <div class="accordion-inner">
                            ...
                            <div class="accordion-group">
                                ...
                                <div id="collapse-empat" class="accordion-body collapse <?php if ($step == 4) {
                                    echo 'in';
                                } ?>">
                                    <div class="accordion-inner">
                                                                        ...
                                                                        <select name="sample<?php echo $no ?>[]" class="chosen" multiple="" data-placeholder="Pilih Sample" tabindex="2">
                                                                            <?php
                                                                                ...
                                                                                foreach ($dpp['data_sample'] as $d):
                                                                                    ...
                                                                                    ?>
                                                                                    <option value="<?php echo $d['id_registrasi_pasien_sample'] ?>" <?php if ($d['id_pemeriksaan_sample'] != '') {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo $d['nama_sample'] . ' ' . $d['jumlah_sample'] . ' ' . ($d['keterangan_sample'] != '' ? ' [' . $d['keterangan_sample'] . ']' : '') ?></option>
                                                                                <?php
                                                                                endforeach;
                                                                        ...
                                                                        <select name="bahan<?php echo $no ?>[]" class="chosen" multiple="" data-placeholder="Pilih Bahan" tabindex="2">
                                                                            <?php
                                                                                ...
                                                                                foreach ($dpp['data_bahan'] as $d):
                                                                                    ...
                                                                                    ?>
                                                                                    <option value="<?php echo $d['id_bahan_pasien'] ?>" <?php if ($d['id_bahan_pengujian_pasien'] != '') {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo $d['nama_bahan'] . ($d['jumlah_bahan'] != '' ? ' [' . $d['jumlah_bahan'] . ']' : '') ?></option>
                                                                                <?php
                                                                                endforeach;
                                        ...
                                        <a class="btn" href="<?php echo Yii::app()->createUrl('registrasi/cetak/hasil_pemeriksaan_new?reg=' . $id_registrasi); ?>" target="_blank" title="Cetak Hasil Pemeriksaan" id=""><i class="icon-print"></i> Cetak Hasil Pemeriksaan (Covid)</a>

                                        <?php
                                            if ($data_registrasi['status_registrasi'] > 0) {
                                                ?>
                                                <hr/>

                                                <?php if (Yii::app()->user->hasFlash('success_notifikasi')): ?>
                                                    <div class="alert alert-success">
                                                ...
                                                <form class="form-horizontal form-validation" method="post" style="">
                                                    ...
                                                    <input type="hidden" name="id_registrasi" value="<?php echo $id_registrasi ?>"/>
                                                    <button type="submit" class="btn btn-success"><i class="icon-arrow-up"></i> Kirim Notifikasi</button>
                                                </form>
                                                <?php
                                            }
                                        ?>
                                        <hr/>
                                        <h3>LAMPIRAN HASIL PEMERIKSAAN</h3><br/>
                                        <?php
                                            foreach ($data_pasien_pemeriksaan as $dpp) {
                                                if ($dpp['file_lampiran'] != '') {
                                                    ?>
                                                    <a class="btn btn-info" href="<?php echo Yii::app()->createUrl('files/hasil_pemeriksaan/' . $dpp['file_lampiran']); ?>" target="_blank" title="Cetak Lampiran" id=""><i class="icon-print"></i> Lampiran : <?php echo $dpp['nama_pengujian'] ?>
                                                    </a>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <div class="alert alert-warning">
                                                        <strong>Tidak ada lampiran hasil
                                                    </div>
                                                    <?php
                                                }
...
<script type="text/javascript">
    $.ajax({
        ...
        data: 'id_pasien=' + $('#id_pasien_hidden').val(),
        type: 'post',
        success: function (data) {
