    ...
    <div class="span12">
        <div class="widget">
            ...
            <div class="widget-content"> 
                <p style="margin: 20px 0px"><a class="btn btn" href="<?php echo Yii::app()->createUrl('registrasi/pemeriksaan_lama/read'); ?>"><i class="icon-chevron-left"></i>&nbsp;&nbsp;Back</a></p>
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane <?php if ($step == 4) echo 'active'; ?>" id="sample">
                            ...
                            <hr/>
                            <h2>Update Sample Pemeriksaan</h2>
                            <form class="form-horizontal form-validation" method="post" style="width: 98%;margin: 10px 10px 10px 10px">
                                <fieldset>
                                    <table id="sample-pemeriksaan-table" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 45%">Pengujian</th>
                                    ...
                                    <table id="pasien-pemeriksaan-table" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data_pasien_pemeriksaan as $dpp) {
                                                ...
                                                <?php
                                                $no++;
                                                $total_pasien_pemeriksaan += $dpp['besar_tarif']*count($dpp['data_sample']);
                                            }
                                            ?>
                                            <tr>
        ...
        if (c === true)
            $.ajax({
                ...
                success: function(data) {
                    $('#pasien-pemeriksaan-table').html(data);
                }
            });
    });
