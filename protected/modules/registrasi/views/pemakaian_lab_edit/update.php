                    ...
                    <div class="tab-content">
                                ...
                                <fieldset>
                                    ...
                                    if (!empty($data_registrasi)) {
                                        ...
                                        <div class="control-group">											
                                            <label class="control-label" for="no_kwitansi_daftar">No.Registrasi</label>
                                            <div class="controls">
                                                <input type="text" class="span4" name="no_kwitansi_daftar" value="">
                                            </div> <!-- /controls -->				
                                        </div> <!-- /control-group -->
                        ...
                        <div class="tab-pane <?php if ($step == 4) echo 'active'; ?> " id="pembayaran">
                            ...
                            <?php if (Yii::app()->user->hasFlash('success_pembayaran')): ?>
                                <div id="alert_pembayaran" class="alert alert-success">
                                    <?php echo Yii::app()->user->getFlash('success_pembayaran'); ?>
                                </div>
                            <?php endif; ?>
                            <?php if (Yii::app()->user->hasFlash('error_pembayaran')): ?>
                                <div id="alert_pembayaran" class="alert alert-error">
                                    <?php echo Yii::app()->user->getFlash('error_pembayaran'); ?>
                                </div>
                            <?php endif; ?>
                            <h2>Form Pembayaran</h2>
                            <form class="form-horizontal form-validation"  action="<?php echo Yii::app()->request->url . '#alert_pembayaran' ?>" method="post" style="width: 98%;margin: 10px 10px 10px 10px">
                                <fieldset>
                                    <div class="control-group">											
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="text" class="span4" name="no_registrasi" readonly="" value="<?php echo $data_registrasi['no_kwitansi_daftar']?>">
                                        </div> <!-- /controls -->				
                                    </div> <!-- /control-group -->
                                    <div class="control-group">											
                                        ...
                                        <div style="width: 50%">
                                            <div class="controls">
                                                <select name="status_pembayaran" class=""  data-placeholder="Pilih Status Pembayaran..." tabindex="2">
                                                    ...
                                                    <option value="2" <?php if($sudah_bayar_bench_fee>0){echo"selected='true'";} ?>>Pelunasan</option>
                                                </select>
                                            </div> <!-- /controls -->				
                                        </div>
                                    </div> <!-- /control-group -->
                                            ...
                                            <table style="width: 40%">
                                                ...
                                                if (!empty($penyewaan_biaya)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left">
                                                            <input type="text" class="span2 biaya_detail"  style="text-align: right" name="besar_biaya_1" value="<?php echo (count($data_anggota_registrasi) + 1) * $penyewaan_biaya['besar_biaya']-$sudah_bayar_bench_fee ?>"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: left">
                                                        ...
                                                        <td style="text-align: left">
                                                            <input type="text" class="span2 biaya_detail"  style="text-align: right" name="besar_biaya_2" value="<?php echo number_format($penyewaan_biaya['besar_deposit']-$sudah_bayar_deposit, 0, '', '') ?>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: left">
                                                        ...
                                                        <td style="text-align: left">
                                                            <input type="text" class="span2 biaya_detail"  style="text-align: right" name="besar_biaya_3" value="<?php echo number_format($penyewaan_biaya['besar_biaya_administrasi']-$sudah_bayar_administrasi, 0, '', '') ?>">
                                                        </td>
                                                    </tr>
                                                    <?php
                                                } else {
