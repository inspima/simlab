                ...
                <form method="post" action="">
                    <div class="form-group">
                        <?php
                            if ($verify_error == '1') {
                                ?>
                                <div class="alert alert-danger" role="alert"><?= $verify_message ?></div>
                                <?php
                            }
                        ?>
                        <label for="verify_code">Kode Verifikasi (Dikirim melalui whatsapp)</label>
                        <input name="verify_code" type="text" class="form-control" placeholder="Kode Verifikasi">
                    </div>
