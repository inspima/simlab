        ...
        <div class="widget">
            ...
            <div class="widget-content">    
                ...
                <p style="margin: 20px 0px">
                    <a href="<?php echo Yii::app()->createUrl('master/unit/create'); ?>" class="btn btn"><i class="icon-plus"></i>&nbsp;&nbsp;Tambah Unit Kerja</a>
                     <a href="<?php echo Yii::app()->createUrl('master/unit/excel'); ?>" class="btn btn"><i class="icon-download-alt"></i>&nbsp;&nbsp;Download Data</a>
                </p>
