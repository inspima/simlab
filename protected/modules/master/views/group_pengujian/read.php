        ...
        <div class="widget">
            ...
            <div class="widget-content">    
                ...
                <p style="margin: 20px 0px">
                    <a href="<?php echo Yii::app()->createUrl('master/group_pengujian/create'); ?>" class="btn btn"><i class="icon-plus"></i>&nbsp;&nbsp;Tambah Group Pengujian</a>
                    <a href="<?php echo Yii::app()->createUrl('master/group_pengujian/excel'); ?>" class="btn btn"><i class="icon-download-alt"></i>&nbsp;&nbsp;Download Data</a>
                </p>
                        ...
                        foreach ($gruoup_uji as $d):
                            ...
                            <tr>
                                ...
                                <td style="width: 120px;text-align: center">
                                    <div>
                                        <a class="btn" title="View" href="<?php echo Yii::app()->createUrl('master/group_pengujian/view?id=' . $d['id_pengujian']); ?>" ><i class="icon-search"></i></a>
                                        <a class="btn" title="Edit" href="<?php echo Yii::app()->createUrl('master/group_pengujian/update?id=' . $d['id_pengujian']); ?>"><i class="icon-edit"></i></a>
    ...
    $(document).ready(function() {
        ...
        $('#rekanan-datatable tbody').on('click', '.rekanan-delete-button', function() {
            ...
            if (c === true)
                $.ajax({
                    type: 'post',
                    url: '<?php echo Yii::app()->createUrl('master/group_pengujian/delete'); ?>',
