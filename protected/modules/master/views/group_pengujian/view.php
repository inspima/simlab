    ...
    <div class="span12">
        <div class="widget">
            ...
            <div class="widget-content">    
                <h2>Data Unit</h2>
                <p style="margin: 20px 0px"><a class="btn btn" href="<?php echo Yii::app()->createUrl('master/group_pengujian/read'); ?>"><i class="icon-chevron-left"></i>&nbsp;&nbsp;Back</a>
                                            <a class="btn btn" href="<?php echo Yii::app()->createUrl('master/group_pengujian/update?id=' . $d['id_pengujian']); ?>">Edit&nbsp;&nbsp;<i class="icon-chevron-right"></i></a></p>
                ...
                <form class="form-horizontal form-validation"  method="post" style="width: 90%">
                    <fieldset>
                        ...
                        <div class="control-group">											
                            <label class="control-label" for="alamat"><b>Nama Group</b></label>
                            <div class="controls">
