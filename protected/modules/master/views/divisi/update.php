                ...
                <form class="form-horizontal form-validation"  method="post" style="width: 90%">
                    <fieldset>
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span3 validate[required]" name="id" value="<?php echo $divisi['id_divisi'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <select name="unit" class="chosen span3" id="kelompok" data-placeholder="Pilih Kelompok..." tabindex="2">
                                    <?php
                                    foreach ($data_unit as $d):
                                        ?>
                                        <option value="<?php echo $d['id_unit'] ?>" <?php
                                        if ($divisi_unit['id_unit'] == $d['id_unit']) {
                                            echo "selected";
                                        }
                        ...
                        <div class="control-group">											
                            <label class="control-label" for="sub_kelompok">DIVISI</label>
                            <div class="controls">
                                <input type="text" class="span6" name="divisi" value="<?php echo $divisi['nama_divisi'] ?>">
                            </div> <!-- /controls -->			
                        </div> <!-- /control-group -->
