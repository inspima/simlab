                ...
                <form class="form-horizontal form-validation"  method="post" style="width: 90%">
                    <fieldset>
                        ...
                        <div class="control-group">											
                            <label class="control-label" for="sub_kelompok">SATUAN SEWA</label>
                            <div class="controls">
                                <input type="text" class="span3" name="satuan_sewa" value="<?php echo $satuan_sewa['nama_satuan'] ?>">
                            </div> <!-- /controls -->			
                        </div> <!-- /control-group -->
