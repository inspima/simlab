                ...
                <form class="form-horizontal form-validation"  method="post" style="width: 90%">
                    <fieldset>
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8 validate[required]" name="kode" value="<?php echo $pengujian['kode_pengujian'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                          ...
                          <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8 validate[required]" name="nama" value="<?php echo $pengujian['nama_pengujian'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <select name="sub_kelompok" class="chosen span5" id="sub_kelompok" data-placeholder="Pilih Subkelompok..." tabindex="2">
                                    <option value="">--</option>
                                    <?php
                                    foreach ($data_subkelompok as $d):
                                        ?>
                                        <option value="<?php echo $d['id_pengujian_subkelompok'] ?>" <?php
                                        if ($subkelompok['id_pengujian_subkelompok'] == $d['id_pengujian_subkelompok']) {
                                            echo "selected";
                                        }
                                        ?>><?php echo $d['nama_subkelompok'] ?></option>
                                        <?php
                                    endforeach;
                                    ?>
                                </select>
                            ...
                            <div class="controls">
                                <select name="kelompok" class="chosen span5" id="sub_kelompok" data-placeholder="Pilih kelompok..." tabindex="2">
                                    ...
                                    foreach ($data_kelompok as $d):
                                        ...
                                        if ($kelompok['id_pengujian_kelompok'] == $d['id_pengujian_kelompok']) {
                                            echo "selected";
                                        }
                            ...
                            <div class="controls">
                                <select name="group" class="chosen span5" id="group" data-placeholder="Pilih group..." tabindex="2">
                                    ...
                                    foreach ($data_group as $d):
                                        ?>
                                        <option value="<?php echo $d['id_pengujian_group'] ?>" <?php
                                       if ($group['id_pengujian_group'] == $d['id_pengujian_group']) {
                                            echo "selected";
                                        }
                                        ?>><?php echo $d['nama_pengujian_group'] ?></option>
                                        <?php
                                    endforeach;
                                    ?>
                                </select>
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8 validate[required]" name="normal" value="<?php echo $pengujian['nilai_normal'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8 validate[required]" name="t_uji" value="<?php echo $pengujian['tarif_pengujian'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8 validate[required]" name="t_konsul" value="<?php echo $pengujian['tarif_konsul'] ?>">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
