                        ...
                        <div class="control-group">											
                            ...
                            <div class="controls">
                                <select name="jenis" class="chosen span5" id="propinsi" data-placeholder="Pilih..." tabindex="2">
                                    ...
                                    foreach ($bj as $d):
                                        ?>
                                        <option value="<?php echo $d['id_bahan_jenis'] ?>"><?php echo $d['nama_bahan_jenis'] ?></option>
                                        <?php
                                    endforeach;
                                    ?>
                                </select>
                         ...
                         <div class="control-group">											
                          ...
                          <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8 validate[required]" name="harga" id="tarif" value="" autocomplete="off" onkeyup="document.getElementById('format').innerHTML = formatCurrency(this.value);"/>
                          ...
                          <div class="control-group">											
                            ...
                            <div class="controls">
                                <input type="text" class="span8" name="ket" value="">
                            </div> <!-- /controls -->				
                        </div> <!-- /control-group -->
