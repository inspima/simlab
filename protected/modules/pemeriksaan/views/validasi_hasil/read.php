                            ...
                            foreach ($data_pasien as $d):
                                ...
                                <tr>
                                    ...
                                    <td style="width: 50px;text-align: center">
                                        <div>
                                            <a class="btn" title="Lihat Sample" href="<?php echo Yii::app()->createUrl('pemeriksaan/validasi_hasil/input?reg=' . $d['id_registrasi_pemeriksaan']); ?>" ><i class=" icon-list-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
