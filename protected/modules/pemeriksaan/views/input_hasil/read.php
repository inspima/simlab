                    ...
                    <form style="margin: 10px" class="form-inline" role="form">
                        <div class="control-group-group">
                                ...
                                <select name="unit" class="form-control chosen" tabindex="2">
                                    ...
                                    <?php
                                        foreach ($data_unit as $d):
                                            if ($id_unit_user == '') {
                                                ?>
                                                <option value="<?php echo $d['id_unit'] ?>" <?php if ($id_unit == $d['id_unit']) {
                                                    echo "selected='true'";
                            ...
                            <?php
                                if (!empty($id_unit)) {
                                    ?>
                                    <a target="_blank" href="<?= Yii::app()->createUrl('pemeriksaan/input_hasil/excel?id_unit=' . $id_unit) ?>" class="btn btn-success"> Upload Excel </a>
                                    <?php
                                }
                            ?>
